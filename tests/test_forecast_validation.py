...
class TestGenerateBaselineDistribution:
    ...
    def test_uniform_binary(self):
        ...
        dist, metadata = forecast.generate_baseline_distribution(event, "baseline_climatology")
    ...
    def test_uniform_binned(self):
        ...
        dist, metadata = forecast.generate_baseline_distribution(event, "baseline_persistence")
